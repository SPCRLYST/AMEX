...
# load the data
charity <- read.csv(file.path("C:/Users/Tyler/Desktop/MSPA/MSPA 422","charity.csv"), sep=",") # load the "charity.csv" file
...
plot.gam(gam.mod, se=TRUE, col="red")
...
write.csv(ip, file.path("C:/Users/Tyler/Desktop/MSPA/MSPA 422","MSPA22_Final_Smith.csv"), row.names=FALSE) # use your initials for the file name
